...
-(void)Start5pEngineAsWidget
{
    ...
    NSString* pWWWPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/h5/www"];
...
-(void)wantsFullScreen:(BOOL)fullScreen
{
    ...
    [[UIApplication sharedApplication] setStatusBarHidden:(_isFullScreen) animated:(_isFullScreen?false:true)];
